...
public class ChatT {
	...
	static class Mouse implements MouseListener {
		...
		public void mouseDown(MouseEvent e) {
			String temp1 = ChatT.text.getText();
			String temp2 = ChatT.text_1.getText();
			ChatT.text.append("\nme: " + temp2);
	...
	public void open() {
		...
		fb = new Firebase("https://brilliant-inferno-9503.firebaseio.com/");
		fb.addValueEventListener(new ValueEventListener() {

			@Override
			public void onDataChange(DataSnapshot snap) {
				if (!((Map<String, String>) snap.getValue()).get("last")
						.equals("teacher")) {
					String s = ((Map<String, String>) snap.getValue())
							.get("text");
